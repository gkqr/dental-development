...
#tab2: st.write("Many kids with Class II occlusion transition to Class I occlusion, which is thought to be more ideal, with growth and development. However, some of them still remain Class II occlusion in permanent dentition. This app provides possibility of maintained Class II occlusion in permanent dentition.")
   ...
   #Initially used slider to select an age, but later, wanted to make it a range, I tried to change it to a range but did not work, got help from Gen AI: I want to select age range than an age?
    ...
    st.write("Humans develop two sets of teeth during their lives: a primary set and a permanent set. T1 represents primary dentition, T2 represents mixed dentition, when the subjects have both primary teeth and permanent teeth, T3 represents permanent dentition.")
